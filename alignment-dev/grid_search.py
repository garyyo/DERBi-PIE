...
def main():
    ...
    model_fr: gensim.models.KeyedVectors = gensim.models.KeyedVectors.load_word2vec_format("alignment/unaligned_models/fr_bible_model.vec")
    model_es: gensim.models.KeyedVectors = gensim.models.KeyedVectors.load_word2vec_format("alignment/unaligned_models/es_bible_model.vec")
    print("here")
